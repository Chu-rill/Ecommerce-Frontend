      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row shadow-lg rounded-lg overflow-hidden max-w-5xl mx-auto">
          ...
          <div className="lg:w-1/2 relative hidden lg:block">
            ...
            <img
              src="https://images.pexels.com/photos/6214142/pexels-photo-6214142.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
              alt="Shopping"
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center text-white">
              ...
              <p className="mb-6">
                Create an account to start shopping, track orders, and discover amazing products tailored just for you.
              </p>
              <p className="text-sm">
