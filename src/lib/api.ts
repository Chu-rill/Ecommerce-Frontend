...
export const authApi = {
  ...
  requestPasswordReset: (data: any) => api.post('/api/v1/auth/reset-password', data),
  confirmPasswordReset: (data: any) => api.post('/api/v1/auth/confirm-reset', data),
...
export const cartApi = {
  ...
  update: (cartId: string, data: any) => api.put(`/api/v1/carts/${cartId}`, data),
...
export const adminApi = {
  ...
  approveProduct: (data: any) => api.post('/api/v1/admin/approve-product', data),
